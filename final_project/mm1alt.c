...
main()  /* Main function. */
{
    ...
    do {
		...
		//printf("num%d: %d  %f  %f\n",++i,server_status,sim_time,area_server_status);
        timing();
...
void initialize(void)  /* Initialization function. */
{
    ...
    time_next_event[2] = 1.0e+30; //departure
    time_next_event[3] = time_end;//end_simulation
}
